...
def test_task1(case_key, case_config):
    ...
    # print(f"Ref")
    # print(f"W_up: {dense_mlp_ref.up_proj}")
    # print(f"W_gate: {dense_mlp_ref.gate_proj}")
    # print(f"W_down: {dense_mlp_ref.down_proj}")
    # print(f"A: {dense_mlp_ref.lora_weight_A}")
    # print(f"B: {dense_mlp_ref.lora_weight_B}")
    # print(f"Mine")
    # print(f"W_up: {dense_mlp.W_up}")
    # print(f"W_gate: {dense_mlp.W_gate}")
    # print(f"W_down: {dense_mlp.W_down}")
    # print(f"A: {dense_mlp.A_r}")
    # print(f"B: {dense_mlp.B_r}")
    # print(f"Ref: {output_ref}")
    # print(f"Mine: {output}")
